...
void callback(const geometry_msgs::PoseStamped::ConstPtr &msg){
    ...
    messaggio.header.frame_id = "odom_gtpose";
   ...
   /* tf::Quaternion q_rpy(
    ...
    // definition of the static tf between map and odom_gtpose
    ...
    br.sendTransform(tf::StampedTransform(transform2, ros::Time::now(), "map", "odom_gtpose"));
    ...
    transform.setOrigin( tf::Vector3(msg->pose.position.x, msg->pose.position.y, 0) );
        ...
        br.sendTransform(tf::StampedTransform(transform, ros::Time::now(), "odom_gtpose", "gtpose"));
